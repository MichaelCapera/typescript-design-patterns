...
uniqueData.add(1);
uniqueData.add(0);
console.log("uniqueData const ==>", uniqueData);
console.log("uniqueData get ==> ", uniqueData.get());
...
orderedData.add(1);
orderedData.add(0);
console.log("orderedData const ==>", orderedData);
console.log("orderedData get ==> ", orderedData.get());

/** Using function  operation*/

const uniqueItems = uniqueData.operation((e: number) => e * 2);
const orderedItems = orderedData.operation((e: number) => e * 2);

console.log('Unique items with operation ==>', uniqueItems);
console.log('Ordered items with operation ==>', orderedItems);